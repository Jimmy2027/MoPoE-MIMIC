...
parser.add_argument('--style_svhn_dim', type=int, default=0, help="dimension of varying factor latent space")
...
parser.add_argument('--num_channels_svhn', type=int, default=3, help="number of channels in images")
